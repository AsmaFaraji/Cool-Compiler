...
void ClassTable::install_basic_classes() {
   ...
   // curr_lineno  = 0;
    ...
    //    
    // *** check what is  append formal and append feature and single feature 
    Class_ Str_class =
	class_(Str, 
	       Object,
	       append_Features(
    ...
    classGraph.insert(std::make_pair(Str_class->class_getName(),Str_cla ss));
}
